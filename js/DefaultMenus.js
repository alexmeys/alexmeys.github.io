...
const menusDataNL = [
  { LBannerT: 'Architectuur | Integratie | Optimalisatie | Advies'},
  { lowerBT: 'Verder' },
  { careerBT: 'Loopbaan' },
...
const menusDataEN = [
  { LBannerT: 'Architecture | Integration | Optimization | Advisory'},
  { lowerBT: 'Continue' },
  { careerBT: 'Career' },
  { skillsBT: 'Skills' },
  { contactBT: 'Contact' }
...
const menusDataFR = [
  { LBannerT: 'Architecture | Intégration | Optimisation | Conseil'},
  { lowerBT: 'Continuer' },
  { careerBT: 'Carrière' },
...
const menusDataPL = [
  { LBannerT: 'Architektura | Integracja | Optymalizacja | Doradztwo'},
  { lowerBT: 'Idź dalej' },
  { careerBT: 'Kariera' },
